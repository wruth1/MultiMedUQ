...
# clusterExport(cl, c("w", "B", "scale", "which_REs"))
# clusterEvalQ(cl, {
#     library(lme4)
#     library(merDeriv)
#     library(tictoc)
...
tic()
MC_results_delta_MC_delta = pblapply(seq_len(num_reps), function(i) {
    ...
    save(output, file = paste0("R/Paper MC Study/Results - Delta, MC Delta/", i, ".RData"))
